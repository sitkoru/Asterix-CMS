...
class controller_get extends default_controller
{
	...
	private function getHTML()
	{
		...
		if( in_array( 'jquery1', model::$settings[ 'js_libraries' ] ) )
			$this->addJS( 'https://code.jquery.com/jquery-1.10.2.min.js' );
		else
		...
		if( in_array( 'jquery-migrate', model::$settings[ 'js_libraries' ] ) ) {
			$this->addJS( 'https://cdnjs.cloudflare.com/ajax/libs/jquery-migrate/1.2.1/jquery-migrate.min.js' );
		}

		//JavaScript
		$this->addJS( 'https://src.sitko.ru/3.0/jquery-ui-1.10.3/ui/jquery-ui.js' );
		$this->addJS( 'https://src.sitko.ru/v4/j/acms_panel.js' );
...
//		$this->addCSS( 'https://src.sitko.ru/3.0/c/panel.css' );
		...
		if( in_array( 'less', model::$settings[ 'js_libraries' ] ) ) {
			$this->addJS( 'https://src.sitko.ru/3.0/less/less-1.5.0.min.js' );
		}
