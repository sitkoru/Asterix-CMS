...
{if $content.code}
    ...
    <form action="" method="post">
        ...
        <div class="btn-group" style="margin-bottom: 10px;">
            <button type="submit" class="btn btn-success btn-sm" title="Сохранить файл стилей"><span class="glyphicon glyphicon-ok"></span></button>
        ...
        <div style="margin-top: 10px;">
            <button type="submit" class="btn btn-success btn-sm">Сохранить файл стилей</button>
            <button type="button" class="btn btn-default btn-sm" OnClick="

var filename = prompt('Укажите название нового айла стилей (без расширения)');
if( filename )
    document.location.href='/dev.styles/'+filename;

    ">Добавить новый файл стилей</button>
        </div>
...
{else}
    ...
    <h1>Управление стилями сайта</h1>
