...
<div class="acms_submit_out">
	<img class="acms_cancel" src="https://src.sitko.ru/i/error.png" alt="Закрыть без сохранения" />
	<img class="acms_save" src="https://src.sitko.ru/i/save.png" alt="Сохранить" />
</div>
...
<form name="edit_record" method="POST" action="/admin{$content.url}.edit.html" enctype="multipart/form-data" class="validate acms_panel_form">
