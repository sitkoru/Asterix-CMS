		...
		{if $field.value.fields}
			{foreach from=$field.value.fields item=feedback_field key=key}
				<li>
					...
					<input type="text" id="field_{$field.sid}_fields_default_{$key}" name="{$field.sid}[fields][default][]" placeholder="По-умолчанию" value="{$feedback_field.default}"/>
...
-->
					...
					<input type="text" id="field_{$field.sid}_fields_default_0" name="{$field.sid}[fields][default][]" placeholder="По-умолчанию" value="{$feedback_field.default}"/>
