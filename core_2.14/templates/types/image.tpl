			...
			{/if}
				...
				<div class="tab-pane" id="lB">
					...
					<div class="alert">
						...
						<strong>Обратите внимание:</strong> фильтры применяются к изображению только в момент загрузки фотографии. К уже загруженной фотографии фильтры не применяются.
					</div>					
				</div>
