	<div class="control-group acms_panel_groups acms_panel_group_{$group_key}">
		...
		<div class="controls">
			<input type="password" class="span2" placeholder="****************" name="{$field.sid}" id="field_{$field.sid}" maxlength="250" x-autocompletetype="{$field.sid}"{if $field.required} required="required"{/if} />
		{if $field.value}	
