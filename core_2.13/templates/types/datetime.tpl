...
<select style="width:60px" name="{$field.sid}[day]" id="{$field.sid}_day">
...
<select style="margin-left:20px;width:60px" name="{$field.sid}[hour]">
...
<span> : </span>
<select style="width:60px" name="{$field.sid}[minute]">
