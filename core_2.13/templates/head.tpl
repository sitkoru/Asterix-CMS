...
{foreach from=$head_add.js_lib item=lib}	<script type="text/javascript" src="{$lib.path}"></script>
{/foreach}
{foreach from=$js_lib item=lib}	<script type="text/javascript" src="{$lib}"></script>
{/foreach}
{foreach from=$head_add.js item=lib}	<script type="text/javascript" src="{$lib.path}"></script>
{/foreach}
{foreach from=$js item=lib}	<script type="text/javascript" src="{$lib}"></script>
{/foreach}
...
{/foreach}
{foreach from=$css item=lib}	<link rel="stylesheet" type="text/css" href="{$lib}"{if $lib.params.media} media="{$lib.params.media}"{/if} />
{/foreach}
