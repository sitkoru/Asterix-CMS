...
//				}
		...
		if($this->model->user->info['id']){
			$this->addJSLib('http://src.sitko.ru/j/jquery.ui.core.js');
			$this->addJSLib('http://src.sitko.ru/j/jquery.ui.widget.js');
			$this->addJSLib('http://src.sitko.ru/j/jquery.ui.mouse.js');
			$this->addJSLib('http://src.sitko.ru/j/jquery.ui.sortable.js');
			$this->addJSLib('http://src.sitko.ru/j/jquery.ui.position.js');
			$this->addJSLib('http://src.sitko.ru/j/jquery.ui.autocomplete.js');
			$this->addJSLib('http://www.cdolivet.com/editarea/editarea/edit_area/edit_area_full.js');
		...
		//CSS
		$this->addCSSLib('http://src.sitko.ru/a/c/lightbox.css');
		$this->addCSSLib('http://jqueryui.com/themes/base/jquery.ui.all.css');
