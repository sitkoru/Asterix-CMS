...
{foreach from=$action.recs item=module key=key}
	<li>
		...
		<a href="#" OnClick="$j('#{$module.id}_structure').toggle('fast'); return false;" style="position:absolute; left:250px; display:inline-block; width:150px; text-align:center;">структура</a> 
		<a href="#" OnClick="$j('#{$module.id}_data').toggle('fast'); return false;" style="position:absolute; left:350px; display:inline-block; width:150px; text-align:center;">данные</a>
		<a href="#" OnClick="$j('#{$module.id}_update').toggle('fast'); return false;" style="position:absolute; left:450px; display:inline-block; width:150px; text-align:center;">обновить</a>
		<a href="#" OnClick="$j('#{$module.id}_delete').toggle('fast'); return false;" style="position:absolute; left:550px; display:inline-block; width:150px; text-align:center;">удалить</a>
...
{foreach from=$action.recs_all item=rec key=key}
	<li>
		{$rec.title} [{$rec.prototype}] - <a href="#" OnClick="$j('#add_module_{$rec.prototype}').toggle('fast'); return false;">подключить</a>
