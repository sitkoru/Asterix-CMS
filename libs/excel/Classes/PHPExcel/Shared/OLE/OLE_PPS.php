...
* @package  OLE
*/
class PHPExcel_Writer_Shared_OLE_PPS
{
    /**
    * The PPS index
    * @var integer
    ...
    */
    function PHPExcel_Writer_Shared_OLE_PPS($No, $name, $type, $prev, $next, $dir, $time_1st, $time_2nd, $data, $children)
    {
        $this->No      = $No;
        $this->Name    = $name;
        $this->Type    = $type;
    ...
    */
    function _getPpsWk()
    {
        ...
        $ret .= pack("v", strlen($this->Name) + 2)  // 66
              ...
              . "\x00\x00\x00\x00"                  // 100
              . PHPExcel_Writer_Shared_OLE::LocalDate2OLE($this->Time1st)       // 108
              . PHPExcel_Writer_Shared_OLE::LocalDate2OLE($this->Time2nd)       // 116
