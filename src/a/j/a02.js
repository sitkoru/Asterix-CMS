...
function getsubtree(url, id) {
    ...
    if (l == 0) {
        $j('#' + id).html('<img src="http://src.opendev.ru/a/i/lightbox-loading.gif" alt="" />');
...
function ask(url, method) {
    ...
    $j('#bar').fadeIn();
    $j('#bar_content').html('<img src="http://src.opendev.ru/a/i/lightbox-loading.gif" alt="загрузка..." id="bar_load" />');
...
function call2(method, action, url, result_id) {
    ...
    //AJAX-preloader
    $j('#bar').fadeIn();
    $j('#' + result_id).html('<img src="http://src.opendev.ru/a/i/lightbox-loading.gif" alt="загрузка..." id="bar_load" />');
...
// Maps
    ...
    $j('.acms_field_gallery .images li').click(function () {
        $j(this).addClass('new');
    });
...
// Events
    ...
    $j('.lightbox').lightBox({
        imageLoading: 'http://src.opendev.ru/a/i/lightbox-loading.gif',
        imageBtnPrev: 'http://src.opendev.ru/a/i/lightbox-btn-prev.gif',
        imageBtnNext: 'http://src.opendev.ru/a/i/lightbox-btn-next.gif',
        imageBtnClose: 'http://src.opendev.ru/a/i/lightbox-btn-close.gif',
        imageBlank: 'http://src.opendev.ru/a/i/lightbox-blank.gif',
