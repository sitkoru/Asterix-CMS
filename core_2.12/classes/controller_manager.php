...
class controller_manager
{
	...
	private function defineController()
	{
		...
		/*
		+   [openid_assoc_handle] => {HMAC-SHA1}{4b0bdbae}{aCXGsw==}
		+   [openid_identity] => http://oleg.mishin.myopenid.com/
		+   [openid_mode] => id_res
		[openid_op_endpoint] => http://www.myopenid.com/server
		[openid_response_nonce] => 2009-11-24T13:12:14ZHtrDct
		+   [openid_return_to] => http://uwdc.opendev.ru
		+   [openid_sig] => xOoNABh1Drh4b82n1UE2GQKVbq0=
		+   [openid_signed] => assoc_handle,identity,mode,op_endpoint,response_nonce,return_to,signed,sreg.email
		*/
