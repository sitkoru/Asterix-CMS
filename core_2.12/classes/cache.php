...
//        $this->log = $log;
        ...
        if( $this->config['cache']['type'] == 'files' )
            BASE_Registry::set('cache', new CACHE_Manager(new CACHE_File( $this->config['cache']['cache_path'] )));
        elseif( $this->config['cache']['type'] == 'memcache' )
            BASE_Registry::set('cache', new CACHE_Manager(new CACHE_MemCache( $this->config['cache']['cache_host'] , $this->config['cache']['cache_port'] )));
